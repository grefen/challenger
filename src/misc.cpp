...
/// engine_info() returns the full name of the current Challenger version. This
/// will be either "Challenger <Tag> DD-MM-YY" (where DD-MM-YY is the date when
/// the program was compiled) or "Challenger <Version>", depending on whether
/// Version is empty.
...
const string engine_info(bool to_uci) {
  ...
  s << "Challenger " << Version << setfill('0');
